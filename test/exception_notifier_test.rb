...
class ExceptionNotifierTest < ActiveSupport::TestCase
  setup do
    ExceptionNotifier.register_exception_notifier(:db, {})
  ...
  test "should have default ignored exceptions" do
    %w[
      ...
      assert_includes ExceptionNotifier.ignored_exceptions, exception
    end
  end

  test "should have db notifier registered" do
    assert_equal ExceptionNotifier.notifiers, [:db]
  end

  test "should have a valid email notifier" do
    @notifier = ExceptionNotifier.registered_exception_notifier(:db)
    refute_nil @notifier
    assert_equal @notifier.class, ExceptionNotifier::DbNotifier
  ...
  test "should allow register/unregister another notifier" do
    ...
    assert_equal ExceptionNotifier.notifiers.sort, %i[db proc]
  ...
  test "should allow select notifiers to send error to" do
    ...
    assert_equal ExceptionNotifier.notifiers.sort, %i[db notifier1 notifier2]
